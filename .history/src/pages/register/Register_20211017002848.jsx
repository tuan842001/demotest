              ...
              <div className="row">
                <div className="col-lg-12 col-md-12 noidungtin">
                  ...
                  >
                    ...
                    <div class="row hide" style={{ marginBottom: "10px" }}>
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <label>
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        ...
                        >
                          ...
                          <option selected="selected" value="SGN">
                            VIETRAVEL HCMC
                          </option>
