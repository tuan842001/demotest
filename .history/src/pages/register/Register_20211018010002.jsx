          ...
          <div className="row">
            <div className="col-md-12" style={{ height: "220px" }}>
              <div className="loginContent">
                <div className="loginContentInner" style={{ top: "23%" }}>
                  ...
                  <div className="loginForm">
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 mg-bot15 text-center">
                          <button
                            type="submit"
                      ...
                      <div class="row">
                        ...
                        <div
                          class="col-md-12 col-sm-12 col-xs-12 mg-bot15 text-center"
