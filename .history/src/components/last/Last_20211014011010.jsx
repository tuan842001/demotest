              ...
              <div className="lastItem">
                <div className="lastItemContainer">
                  ...
                  <div className="lastText">
                    ...
                    Imbiah Lookout, Siloso Point, Beaches và Resorts World
                    Sentosa với nhiều khu vui chơi giải trí phù hợp với nhu cầu
                    của khách tham quan.
                  </div>
            ...
            <div className="lastRight">
              <div className="lastItem">
                <div className="lastItemContainer">
                  ...
                  <div className="lastText">
                    Kể từ thời điểm này, nếu bạn đến Paris và ghé thăm tháp
                    Eiffel ở cự ly gần sẽ được nhìn thấy một bức tường kính ngay
                    dưới chân tháp.
                  </div>
                  <div className="lastButton">
                    <a href="#">Xem chi tiết</a>
