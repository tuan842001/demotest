    ...
    <div class="special">
			...
			<div class="special_content">
				<div class="special_slider_container">
					<div class="owl-carousel owl-theme special_slider owl-loaded owl-drag">
						{/* <!-- Special Offers Item --> */}
					...
					<div class="owl-stage-outer"><div class="owl-stage" style="transition: all 0.7s ease 0s; width: 4186px; padding-left: 190px; padding-right: 190px; transform: translate3d(-692px, 0px, 0px);"><div class="owl-item cloned" style="width: 341px; margin-right: 5px;"><div class="owl-item">
						...
						</div></div><div class="owl-item cloned active" style="width: 372px;margin-right: 5px;"><div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
						...
						</div></div><div class="owl-item cloned active" style="width: 341px; margin-right: 5px;"><div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
						...
						</div></div><div class="owl-item active center" style="width: 341px; margin-right: 5px;"><div class="owl-item">
						...
						</div></div><div class="owl-item" style="width: 341px; margin-right: 5px;"><div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
						...
						</div></div><div class="owl-item cloned" style="width: 341px; margin-right: 5px;"><div class="owl-item">
							<div class="special_item">
								<div class="special_item_background"><img src="view/images/special_1.jpg"></div>
								<div class="special_item_content text-center">
									<div class="special_category">Visiting</div>
