    ...
    <div class="special">
			...
			<div class="special_content">
				<div class="special_slider_container">
					...
					<div class="owl-stage-outer"><div class="owl-stage" style={{transition: "all 0.7s ease 0s;", width: "4186px;", paddingLeft: "190px;", paddingRight: "190px;", transform: "translate3d(-692px, 0px, 0px)"}}><div class="owl-item cloned" style={{width: "341px;", marginRight: "5px;"}}><div class="owl-item">
