    ...
    return (
			...
			<div class="special_content">
				<div class="special_slider_container">
					...
					<div class="owl-stage-outer"><div class="owl-stage" style={{transition: "all 0s ease 0s", width: "3922px", paddingleft: "190px", paddingright: "190px" transform: "translate3d(-644px, 0px, 0px)"}}><div class="owl-item cloned" style={{width: "317px", marginright: "5px"}}><div class="owl-item">
