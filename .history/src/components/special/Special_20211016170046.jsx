...
<div class="special_content">
	<div class="special_slider_container">
        ...
        <div class="owl-stage" style={{transition: "all 0.7s ease 0s;", width: "4186px;", paddingLeft: "190px;", paddingRight: "190px;", transform: "translate3d(-692px, 0px, 0px)"}}>

          <div class="owl-item cloned" style={{width: "341px;", marginRight: "5px;"}}>
            <div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
								<div class="special_item_background">
                  <img src="view/images/special_3.jpg"/>
                </div>
          ...
          <div class="owl-item cloned active" style={{width: "372px", marginRight: "5px"}}>
            <div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
								<div class="special_item_background">
                  <img src="view/images/special_4.jpg"/>
                </div>
								<div class="special_item_content text-center">
          ...
          <div class="owl-item cloned active" style={{width: "341px", marginRight: "5px"}}>
            <div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
								<div class="special_item_background">
                <img src="view/images/special_5.jpg"/>
              </div>
								<div class="special_item_content text-center">
									<div class="special_category">Visiting</div>
          ...
          <div class="owl-item active center" style={{width: "341px", marginRight: "5px"}>
            <div class="owl-item">
          ...
          <div class="owl-item" style={{width: "341px", marginRight: "5px"}>
            <div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
