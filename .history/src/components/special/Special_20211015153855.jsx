    ...
    return (
			...
			<div class="special_content">
				<div class="special_slider_container">
					...
					<div class="owl-stage-outer"><div class="owl-stage" style={{transition: "all 0s ease 0s", width: "3922px", paddingleft: "190px", paddingright: "190px", transform: "translate3d(-644px, 0px, 0px)"}}></div><div class="owl-item cloned" style={{width: "317px", marginright: "5px"}}><div class="owl-item">
						...
						</div></div><div class="owl-item cloned active" style={{width: "317px", marginright: "5px"}}><div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
						...
						</div></div><div class="owl-item active center" style={{width: "317px", marginright: "5px"}}><div class="owl-item">
						...
						</div></div><div class="owl-item" style={{width: "317px", marginright: "5px"}}><div class="owl-item">
							<div class="special_item d-flex flex-column align-items-center justify-content-center">
						...
						</div></div><div class="owl-item cloned" style={{width: "317px", marginright: "5px"}}><div class="owl-item">
							<div class="special_item">
								<div class="special_item_background"><img src="view/images/special_1.jpg"/></div>
								<div class="special_item_content text-center">
									<div class="special_category">Visiting</div>
