  ...
  return (
    <div className="offers">
      <div className="container">
        ...
        <div className="row">
          <div className="col">
            <div class="items item_grid clearfix" style="position: relative; height: 699px;">
                <div class="item clearfix rating_5 box" style="position: absolute; left: 0px; top: 0px;"></div>
            </div>
            ...
            <div class="items item_grid clearfix" style="position: relative; height: 699px;">
				<div class="item clearfix rating_5 box" style="position: absolute; left: 0px; top: 0px;">
				    <a href="#">
					    <div class="item_image"><img src="./assets/images/tour/Langbiang-dalat-vietnam_519197881.jpg"></div>
							...
							<div class="item_more_link">Chiêm ngưỡng vẻ đẹp của biển Cà Ná - một trong những bãi biển đẹp của miền Trung</div>
						</div>
				    </a>
		        </div>
			</div>
