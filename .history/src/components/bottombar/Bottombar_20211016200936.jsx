  ...
  return (
    <div className="bottombar">
      ...
      <div className="bottomRight">
        ...
        <input name="__RequestVerificationToken" type="hidden" value="KNrZ1gERBb-tob3Ne9Bfea85MtEdkDQnoRGDS1pATTXZae8mKIJhsPDGtmDHyt2BIST9XQPfMuaBHf42sLfjDGDYedV0YhfjucG_EPgfCxs1">
